...
const lightTheme = EditorView.theme({
  "&": { height: "100%", backgroundColor: "#eaeaea", color: "#111111" },
  ...baseThemeConfig,
  ".cm-content": { ...baseThemeConfig[".cm-content"], caretColor: "#111111" },
  ".cm-cursor": { ...baseThemeConfig[".cm-cursor"], borderLeftColor: "#111111" },
  ".cm-gutters": { ...baseThemeConfig[".cm-gutters"], backgroundColor: "#eaeaea", color: "#888888" },
  ".cm-activeLineGutter": { backgroundColor: "transparent", color: "#444444" },
  ...
  ".cm-foldPlaceholder": { backgroundColor: "#e0e0e0", border: "1px solid #d4d4d4", color: "#999999" },
  ".cm-tooltip": { backgroundColor: "#eaeaea", border: "1px solid #d4d4d4", color: "#1f1f1f", boxShadow: "0 2px 8px rgba(0,0,0,0.08)" },
  ".cm-panels": { backgroundColor: "#eaeaea", color: "#1f1f1f" },
...
const lightHL = syntaxHighlighting(
  HighlightStyle.define([
    { tag: tags.heading1, color: "#000000", fontWeight: "700", fontSize: "1.3em" },
    { tag: tags.heading2, color: "#111111", fontWeight: "600", fontSize: "1.15em" },
    { tag: tags.heading3, color: "#1a1a1a", fontWeight: "600", fontSize: "1.05em" },
    { tag: tags.heading4, color: "#1a1a1a", fontWeight: "600" },
    { tag: tags.emphasis, color: "#222222", fontStyle: "italic" },
    { tag: tags.strong, color: "#000000", fontWeight: "700" },
    { tag: tags.link, color: "#0969da", textDecoration: "underline" },
    { tag: tags.url, color: "#0969da" },
    { tag: tags.monospace, color: "#0550ae", fontFamily: "inherit" },
    { tag: tags.quote, color: "#333333", fontStyle: "italic" },
    { tag: tags.strikethrough, textDecoration: "line-through", color: "#666666" },
    { tag: tags.meta, color: "#444444" },
    { tag: tags.processingInstruction, color: "#444444" },
    { tag: tags.comment, color: "#444444" },
